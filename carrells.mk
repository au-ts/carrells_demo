...
SYSTEM_FILE := $(BUILD_DIR)/caerrells.system
...
IMAGES = client_vmm.elf timer_driver.elf serial_driver.elf serial_virt_tx.elf serial_virt_rx.elf \
	network_virt_rx.elf network_virt_tx.elf eth_driver.elf network_copy.elf network_vswitch.elf timer_driver.elf
...
$(SYSTEM_FILE): $(METAPROGRAM) $(IMAGES) |$(BUILD_DIR)
	...
	PYTHONPATH=${SDDF}/tools/meta:$$PYTHONPATH $(PYTHON) $(METAPROGRAM) --sddf $(SDDF) --board $(X86_BOARD) --output . --sdf $(SYSTEM_FILE) $(PARTITION_ARG)
